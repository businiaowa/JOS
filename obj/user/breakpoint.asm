...
sys_env_destroy(envid_t envid)
{
  ...
  8000f9:	68 0a 0e 80 00       	push   $0x800e0a
  8000fe:	6a 23                	push   $0x23
  800100:	68 27 0e 80 00       	push   $0x800e27
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80014d:	56                   	push   %esi
  80014e:	50                   	push   %eax
  80014f:	68 38 0e 80 00       	push   $0x800e38
  ...
  800160:	e8 54 00 00 00       	call   8001b9 <vcprintf>
	cprintf("\n");
  800165:	c7 04 24 5c 0e 80 00 	movl   $0x800e5c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002b8:	0f be 80 5e 0e 80 00 	movsbl 0x800e5e(%eax),%eax
  8002bf:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80037a:	ff 24 85 00 0f 80 00 	jmp    *0x800f00(,%eax,4)
  ...
  800441:	8b 14 85 60 10 80 00 	mov    0x801060(,%eax,4),%edx
  800448:	85 d2                	test   %edx,%edx
  80044a:	75 1b                	jne    800467 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  80044c:	50                   	push   %eax
  80044d:	68 76 0e 80 00       	push   $0x800e76
  800452:	53                   	push   %ebx
  800453:	56                   	push   %esi
  ...
  800467:	52                   	push   %edx
  800468:	68 7f 0e 80 00       	push   $0x800e7f
  80046d:	53                   	push   %ebx
  80046e:	56                   	push   %esi
  ...
  800492:	b8 6f 0e 80 00       	mov    $0x800e6f,%eax
