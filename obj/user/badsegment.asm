...
sys_env_destroy(envid_t envid)
{
  ...
  8000fe:	68 0a 0e 80 00       	push   $0x800e0a
  800103:	6a 23                	push   $0x23
  800105:	68 27 0e 80 00       	push   $0x800e27
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800152:	56                   	push   %esi
  800153:	50                   	push   %eax
  800154:	68 38 0e 80 00       	push   $0x800e38
  ...
  800165:	e8 54 00 00 00       	call   8001be <vcprintf>
	cprintf("\n");
  80016a:	c7 04 24 5c 0e 80 00 	movl   $0x800e5c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002bd:	0f be 80 5e 0e 80 00 	movsbl 0x800e5e(%eax),%eax
  8002c4:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80037f:	ff 24 85 00 0f 80 00 	jmp    *0x800f00(,%eax,4)
  ...
  800446:	8b 14 85 60 10 80 00 	mov    0x801060(,%eax,4),%edx
  80044d:	85 d2                	test   %edx,%edx
  80044f:	75 1b                	jne    80046c <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  800451:	50                   	push   %eax
  800452:	68 76 0e 80 00       	push   $0x800e76
  800457:	53                   	push   %ebx
  800458:	56                   	push   %esi
  ...
  80046c:	52                   	push   %edx
  80046d:	68 7f 0e 80 00       	push   $0x800e7f
  800472:	53                   	push   %ebx
  800473:	56                   	push   %esi
  ...
  800497:	b8 6f 0e 80 00       	mov    $0x800e6f,%eax
