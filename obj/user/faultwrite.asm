...
sys_env_destroy(envid_t envid)
{
  ...
  800102:	68 0a 0e 80 00       	push   $0x800e0a
  800107:	6a 23                	push   $0x23
  800109:	68 27 0e 80 00       	push   $0x800e27
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800156:	56                   	push   %esi
  800157:	50                   	push   %eax
  800158:	68 38 0e 80 00       	push   $0x800e38
  ...
  800169:	e8 54 00 00 00       	call   8001c2 <vcprintf>
	cprintf("\n");
  80016e:	c7 04 24 5c 0e 80 00 	movl   $0x800e5c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002c1:	0f be 80 5e 0e 80 00 	movsbl 0x800e5e(%eax),%eax
  8002c8:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800383:	ff 24 85 00 0f 80 00 	jmp    *0x800f00(,%eax,4)
  ...
  80044a:	8b 14 85 60 10 80 00 	mov    0x801060(,%eax,4),%edx
  800451:	85 d2                	test   %edx,%edx
  800453:	75 1b                	jne    800470 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  800455:	50                   	push   %eax
  800456:	68 76 0e 80 00       	push   $0x800e76
  80045b:	53                   	push   %ebx
  80045c:	56                   	push   %esi
  ...
  800470:	52                   	push   %edx
  800471:	68 7f 0e 80 00       	push   $0x800e7f
  800476:	53                   	push   %ebx
  800477:	56                   	push   %esi
  ...
  80049b:	b8 6f 0e 80 00       	mov    $0x800e6f,%eax
